...
class Body1(object):
    ...
    def __init__(self, name=None, cost=None):  # noqa: E501
    ...
    @property
    def cost(self):
        """Gets the cost of this Body1.  # noqa: E501

        The number of credits a single consumption of this Item requires (unit for credits is smallest unit in currency used)  # noqa: E501

        :return: The cost of this Body1.  # noqa: E501
        :rtype: int
        """
        return self._cost
    ...
    @cost.setter
    def cost(self, cost):
        """Sets the cost of this Body1.

        The number of credits a single consumption of this Item requires (unit for credits is smallest unit in currency used)  # noqa: E501

        :param cost: The cost of this Body1.  # noqa: E501
        :type: int
        """
        if cost is None:
