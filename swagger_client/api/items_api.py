...
class ItemsApi(object):
    ...
    def items_item_id_consume_patch(self, item_id, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.items_item_id_consume_patch(item_id, async=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async'):
            return self.items_item_id_consume_patch_with_http_info(item_id, **kwargs)  # noqa: E501
        else:
            (data) = self.items_item_id_consume_patch_with_http_info(item_id, **kwargs)  # noqa: E501
            return data

    def items_item_id_consume_patch_with_http_info(self, item_id, **kwargs):  # noqa: E501
        """Consumes a Item  # noqa: E501

        Consumes a Item and subtracts the cost of the Item from the credit of the user. If not enough credit exists the operation will be rejected  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.items_item_id_consume_patch_with_http_info(item_id, async=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method items_item_id_consume_patch" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if ('item_id' not in params or
            ...
            raise ValueError("Missing the required parameter `item_id` when calling `items_item_id_consume_patch`")  # noqa: E501
    ...
    def items_item_id_patch(self, item_id, name, cost, **kwargs):  # noqa: E501
        """Update Item  # noqa: E501

        Update Item. This can only be done by admins  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.items_item_id_patch(item_id, name, cost, async=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async'):
            return self.items_item_id_patch_with_http_info(item_id, name, cost, **kwargs)  # noqa: E501
        else:
            (data) = self.items_item_id_patch_with_http_info(item_id, name, cost, **kwargs)  # noqa: E501
            return data

    def items_item_id_patch_with_http_info(self, item_id, name, cost, **kwargs):  # noqa: E501
        """Update Item  # noqa: E501

        Update Item. This can only be done by admins  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.items_item_id_patch_with_http_info(item_id, name, cost, async=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method items_item_id_patch" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'item_id' is set
        if ('item_id' not in params or
                params['item_id'] is None):
            raise ValueError("Missing the required parameter `item_id` when calling `items_item_id_patch`")  # noqa: E501
        # verify the required parameter 'name' is set
        if ('name' not in params or
                params['name'] is None):
            raise ValueError("Missing the required parameter `name` when calling `items_item_id_patch`")  # noqa: E501
        # verify the required parameter 'cost' is set
        if ('cost' not in params or
                params['cost'] is None):
            raise ValueError("Missing the required parameter `cost` when calling `items_item_id_patch`")  # noqa: E501

        if 'cost' in params and params['cost'] < 0:  # noqa: E501
            raise ValueError("Invalid value for parameter `cost` when calling `items_item_id_patch`, must be a value greater than or equal to `0`")  # noqa: E501
        collection_formats = {}
